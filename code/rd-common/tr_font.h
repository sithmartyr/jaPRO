...
int RE_Font_StrLenPixels(const char *psText, const int iFontHandle, const float fScale = 1.0f, float xadjust=1, float yadjust=1);
int RE_Font_StrLenChars(const char *psText);
int RE_Font_HeightPixels(const int iFontHandle, const float fScale = 1.0f, float xadjust=1, float yadjust=1);
void RE_Font_DrawString(int ox, int oy, const char *psText, const float *rgba, const int iFontHandle, int iMaxPixelWidth, const float fScale = 1.0f, float xadjust=1, float yadjust=1);
